...
final class gadgetapiTest extends testBaseClass {
    ...
    public function testGadget(): void {
        ...
        $this->assertSame('{{cite journal|last1=Leyser Da Costa Gouveia |first1=Tiago |last2=Maganas |first2=Dimitrios |last3=Neese |first3=Frank |title=Restricted Open-Shell HartreeÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“Fock Method for a General Configuration State Function Featuring Arbitrarily Complex Spin-Couplings |journal=The Journal of Physical Chemistry A |date=2024 |volume=128 |issue=25 |pages=5041ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“5053 |doi=10.1021/acs.jpca.4c00688 |pmid=<!-- --> |arxiv=<!-- --> |pmc=<!-- --> |url=<!-- --> }}', $json->expandedtext);
