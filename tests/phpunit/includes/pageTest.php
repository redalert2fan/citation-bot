...
final class pageTest extends testBaseClass {
    ...
    public function testPageChangeSummary32(): void { // Mixture of dropping chapter-url and moving URL to chapter-url. Bogus template content with duplicate authors
        ...
        $this->assertSame('Add: mr, publisher, date. Removed parameters. Some additions/deletions were parameter name changes. Removed duplicate authors. | [[:en:WP:UCB|Use this bot]]. [[:en:WP:DBUG|Report bugs]]. ', $page->edit_summary());
    }
