...
const GROUP6 = ['series', 'script-article', 'script-chapter', 'script-contribution', 'script-encyclopaedia', 'script-encyclopedia', 'script-entry', 'script-journal', 'script-magazine', 'script-map', 'script-newspaper', 'script-periodical', 'script-quote', 'script-section', 'script-title', 'script-website', 'script-work', 'station'];
...
const GROUP10 = ['page', 'pages', 'at', 'p', 'pp', 'no-pp', 'sheet', 'sheets', 'message-id', 'minutes'];
...
const GROUP25 = ['lccn', 'issn', 'ol', 'oclc', 'asin', 's2cid', 's2cid-access', 'eissn', 'docket', 'ol-access', 'ismn', 'sbn'];
const GROUP26 = ['url'];
...
const GROUP30 = ['template-doc-demo', 'id', 'type', 'via', 'citation_bot_placeholder_bare_url', 'df', 'trans-quote', 'air-date', 'airdate', 'archive-format', 'asin-tld', 'assign', 'assignee', 'audio-visual', 'cartography', 'collaboration', 'country-code', 'country', 'credits', 'degree', 'department', 'description', 'transcript', 'version', 'episode-link', 'event', 'format', 'inset', 'lang', 'language', 'mailing-list', 'map', 'map-format', 'map-url-access', 'medium', 'mode', 'name-list-style', 'network', 'newsgroup', 'no-tracking', 'patent-number', 'postscript', 'quotation', 'quote', 'quote-page', 'quote-pages', 'ref', 'scale', 'title-note', 'trans-entry', 'trans-map', 'trans-section'];
