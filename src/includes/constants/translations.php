...
const MK_TRANS = [
    ...
    'Standardized Google Books URLs. ' => 'Стандардизирани Google Books URL-адреси. ',
    'Removed unsupported issue parameter from cite book. ' => 'Отстранет неподдржан параметар за издание од наведена книга. ',
...
const RU_TRANS = [
    ...
    'Standardized Google Books URLs. ' => 'Стандартизированы URL-адреса Google Books. ',
    'Removed unsupported issue parameter from cite book. ' => 'Удален неподдерживаемый параметр выпуска из cite book. ',
...
const SR_TRANS = [
    ...
    'Standardized Google Books URLs. ' => 'Стандардизовани Google Books URL-ови. ',
    'Removed unsupported issue parameter from cite book. ' => 'Уклоњен неподржан параметар издања из cite book. ',
...
const VI_TRANS = [
    ...
    'Standardized Google Books URLs. ' => 'Đã chuẩn hóa URL Google Books. ',
    'Removed unsupported issue parameter from cite book. ' => 'Đã xóa tham số phát hành không được hỗ trợ từ cite book. ',
